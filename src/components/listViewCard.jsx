...
const ListViewCard = ({ book }) => {
  return (
    <div className="w-full max-w-4xl mx-auto bg-[#FAF7F0] rounded-lg shadow-lg p-6 flex items-center space-x-4">
      {/* Image */}
      ...
      <div className="flex flex-col h-full justify-between">
        ...
        {/* Button */}
        <button className="bg-green-600 text-white px-2 md:px-6 py-2 rounded-lg text-lg font-semibold flex">
