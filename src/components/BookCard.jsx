...
const BookCard = ({ book }) => {
  ...
  >
    ...
    {/* Book Description */}
    <div className="absolute bg-white/80 backdrop-blur-sm w-44 h-full opacity-0 group-hover:opacity-100 p-2 flex flex-col justify-between top-0 transition-all duration-500 rounded-lg z-10 items-center border-2 border-gray-300">
