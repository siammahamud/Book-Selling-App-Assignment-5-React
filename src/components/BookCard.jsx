...
const BookCard = ({book}) => {
  return (
    <div
          key={book.name}
          className="relative shadow-[1px_1px_5px_gray] dark:shadow-[0_0_4px_white] rounded-md group z-0 w-40 md:w-44 h-60"
        >
          {/* book image  */}
          <div className="w-full h-full">
            <img
              className="w-full h-full rounded-md group-hover:opacity-70"
              src={book.image_url}
              alt={book.bookname}
            />
          </div>
